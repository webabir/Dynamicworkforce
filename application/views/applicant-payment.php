...
<div id="allData" class="all-data">
        <div class="container contact pb-5 pt-5">
             <div class="theme-bg-ass-blue rounded text-white d-flex flex-wrap align-items-center justify-content-between justify-content-center-428 p-3">
                <h4 class="fw-bold text-white mb-md-0 mb-2 mx-3">Payment list</h4>
            ...
            <div class="table-desktop-view" style="overflow-x: scroll;">
                <table>
                    ...
                    <tbody id="myTable">
                        <?php foreach ($paymentDetails->result() as $row) {?>
            ...
            <div class="table-mobile-view">
                ...
                <div class="user-box mb-2">
                    ...
                    <div class="d-flex"><span class="d-block me-3" style="width:116px;">Payment Method </span>: <span class="d-block ms-3 text-break"><?php echo $row->payment_method;?></span></div>
                    ...
                    <div class="d-flex"><span class="d-block me-3" style="width:116px;">Transection Id </span>: <span class="d-block ms-3 text-break"><?php echo $row->transection_id;?></span></div>
                    <div class="d-flex"><span class="d-block me-3" style="width:116px;">Date And Time </span>: <span class="d-block ms-3 text-break"><?php echo $row->date_time;?></span></div>
                </div>
                <?php }?>
            </div>
        </div>
